...
function App() {
  ...
  return (
    ...
    <style>{`
        ...
        .form-card {
            /* Desktop par ye normal div rahega */
            width: 100%;
        }
        ...
        @media (max-width: 768px) {
            .app-container {
                display: block; /* Stack mode */
                overflow-y: auto; /* Enable Page Scroll */
                height: 100vh;
            }

            /* 1. Earth becomes Background */
            .canvas-container {
                position: fixed;
                top: 0; left: 0; width: 100%; height: 100%;
                z-index: 0;
                opacity: 0.6; /* Dim the earth */
                pointer-events: none; /* No touch on earth in mobile */
            }

            /* 2. Sidebar Removed, converted to Centered Card */
            .sidebar {
                width: 100%;
                height: auto;
                min-height: 100vh;
                background: transparent; /* See through to Earth */
                border: none;
                padding: 20px;
                display: flex;
                flex-direction: column;
            ...
            /* 3. The Form becomes a Floating Glass Card */
            .form-card {
            ...
            /* Hide CRT effect on mobile for cleaner look */
    ...
    <div className="app-container">
      ...
      <div className="crt-effect" style={crtOverlayStyle}></div>
      <div className="crt-effect" style={vignetteStyle}></div>

      {/* 3D EARTH (Background for Mobile, Side for Desktop) */}
      ...
      <div className="sidebar">
        ...
        {/* THIS DIV BECOMES THE CARD ON MOBILE */}
        <div className="form-card">
            ...
            <div className="footer" style={{textAlign: "center", fontSize: "0.7rem", color: "#666", marginTop: "10px"}}>
                DEC - 2025 | Dev by Sayyed Mohsin Ali
            </div>
        </div>
      </div>
